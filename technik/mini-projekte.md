# Mini-Projekte — Grundlagen-Drills für unter der Woche

*Kleine Übungen (10–45 Min.), die je eine Grundtechnik trainieren und als
Add-on normale Gerichte aufwerten. Kein Menü-Charakter: eins pro Abend neben
dem normalen Kochen reicht. Kern-Learning vom Hochzeitstags-Menü gilt hier
doppelt: **Aufwand ≠ Wow — perfekte Ausführung simpler Techniken wirkt oft
mehr als Komplexität.***

*Konvention: exakte Mengen wie überall im Repo. Salz-Startwerte und
Rettungs-Tabelle → [Abschmecken-Spickzettel](/technik/abschmecken.md).*

---

## Block 1 — Kalte Emulsionen

### Vinaigrette nach Formel (10 Min.)

**Lehrt:** Säure-Fett-Balance, Emulsion ohne Ei, Abschmecken bei kalt.
...
### Mayonnaise von Hand (15 Min.)

**Lehrt:** die Mutter aller Emulsionen — Gefühl fürs Brechen und Retten.

- 1 Eigelb (Zimmertemperatur!), 1 TL Dijon-Senf, 1 TL Zitronensaft, ¼ TL Salz
  verrühren. 200 ml neutrales Öl erst tropfenweise, dann in dünnem Faden
  einschlagen. Am Ende mit 1 TL Wasser oder Zitronensaft auf Konsistenz bringen.
- **Bewusst einmal brechen lassen** (Öl zu schnell) und retten: 1 EL warmes
  Wasser in eine saubere Schüssel, gebrochene Masse tropfenweise einschlagen.
- Schnellvariante danach: Stabmixer-Mayo — 1 ganzes Ei + 250 ml Öl in ein
  schmales Gefäß (kaum breiter als der Mixerkopf), Mixer auf den Boden,
  einschalten, 10 s stehen lassen, langsam hochziehen.
...
**Schon im Repo:** Toum (Emulsion ohne Ei) → [Shawarma, libanesisch](/gerichte/shawarma-libanesisch.md).

## Block 2 — Warme Emulsionen (der größte Alltags-Hebel)

### Pfannensauce mit montierter Butter (15 Min.)

**Lehrt:** Deglacieren, Reduktion, Butter montieren — verwandelt jedes
„Fleisch + Beilage" in ein Gericht mit Sauce.

- Nach dem Braten (Kotelett, Hähnchen, Steak): Fleisch raus, überschüssiges
  Fett bis auf 1 EL abgießen, Bratensatz mit 100 ml Weißwein loskochen,
  fast komplett reduzieren. 150 ml Brühe zugeben, auf ⅓ reduzieren.
...
**Lehrt:** Butteremulsion in Reinform, Temperaturführung mit Thermometer.

- 1 Schalotte fein, mit 60 ml Weißwein + 30 ml Weißweinessig auf ~2 EL
  reduzieren. Bei kleinster Hitze 125 g kalte Butter würfelweise einschlagen.
...
## Block 3 — Fett als Aromaträger

### Kräuteröl, blanchiert (30 Min. + Abtropfzeit)

**Lehrt:** Chlorophyll fixieren, Passiertuch-Arbeit — leuchtend grünes Öl
statt trübem Kräutermatsch.

- 100 g weiche Kräuter (Petersilie, Schnittlauch, Basilikum — auch gemischt)
  10 s blanchieren, sofort in Eiswasser, **sehr gut** trocken drücken.
- Mit 200 ml neutralem Öl 2–3 Min. im Stabmixer/Mixer mixen, bis das Öl
  gut warm ist (~60 °C — die Wärme hilft der Extraktion). Durch das Passiertuch abtropfen
...
### Beurre noisette (10 Min.)

**Lehrt:** Milchzucker/Protein-Bräunung hören und riechen — der Übergang von
nussig zu verbrannt ist ~30 Sekunden.
...
**Lehrt:** Aromen-Extraktion über Öltemperatur statt Kochen.

- 3 EL grobe Chiliflocken (Gochugaru oder Pul Biber — beides milde Basis) +
  1 TL Sesam + 1 kleingeschnittene Frühlingszwiebel (nur Grün) in eine
  hitzefeste Schüssel. 150 ml neutrales Öl auf **110–120 °C** (Thermometer)
...
### Knoblauch-Confit (10 Min. aktiv + 45 Min. Ofen)

**Lehrt:** Confieren im Kleinformat.

- 2–3 Knollen geschälte Zehen knapp mit Olivenöl bedecken (kleine Ofenform),
  1 Zweig Thymian, bei 100–120 °C ~45–60 Min. bis butterweich.
...
## Block 4 — Säure, Frische, Textur (die „Kontrast fehlt"-Abteilung)

### Quick Pickles (15 Min. + 1 h Ziehzeit)

**Lehrt:** Säure als Baustein planen statt am Ende retten.
...
### Gremolata / Salsa verde (10 Min.)

**Lehrt:** Messerarbeit fein + rohes Finish dosieren.

- Gremolata: Zeste von 1 Bio-Zitrone, 1 Knoblauchzehe, 1 Bund glatte
  Petersilie — alles sehr fein, erst kurz vor Servieren mischen.
...
**Lehrt:** Textur als eigene Komponente denken.

- 60 g Panko oder geriebenes altbackenes Brot in 2 EL Olivenöl mit 1 leicht
...
### Pochiertes Ei (15 Min., mehrere Versuche einplanen)

**Lehrt:** Temperaturfenster halten, Frische-Erkennung beim Ei.

- Frisches Ei in ein feines Sieb schlagen (dünnflüssiges Eiweiß abtropfen —
