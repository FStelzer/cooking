...
Türkisch-osmanischer Klassiker („der Imam fiel in Ohnmacht" — je nach Legende
vor Verzückung oder wegen des Olivenölverbrauchs). Gehört zur Familie der
*zeytinyağlı* — in Olivenöl geschmortes Gemüse, das lauwarm oder
zimmerwarm gegessen wird. Gleiche Sommer-Logik wie Oktopus und Tafelspitz:
mittags kochen, abends essen, Küche bleibt kühl.

## Stil-Entscheidung

- **Auberginen im Ofen vorrösten statt frittieren.** Traditionell werden sie
  in reichlich Öl gebraten; Rösten liefert 90 % des Ergebnisses bei einem
...
- **Olivenöl ist Zutat, nicht Medium.** ~180 ml im Gericht sind gewollt und
  ...
  Hitze, Geduld, das Öl bindet am Ende mit Tomate und Zwiebelsaft zu einer
  seidigen Sauce.
- **Zwiebeln sind die halbe Füllung.** Kein Sparen: langsam weich und süß
  geschmort sind sie das Rückgrat des Gerichts.
...
- Von Haus aus null Schärfe — Pul Biber nur pro Teller.
- Kein Alkohol im Gericht.
- Weiche süße Zwiebel-Tomaten-Füllung mit Joghurt und Brot ist zugänglich;
...
- **Variante große Auberginen:** REWE-Riesen längs halbieren, Schnittfläche
  einritzen, salzen, rösten, dann als „Schiffchen" füllen — gleiche Zeiten,
  robusteres Handling.
- **Menü-Gedanke:** Funktioniert als Hauptgang mit Bulgur oder als Teil einer
  Meze-Tafel (mit Joghurt-Dips, Oliven, Feta — Überschneidung mit dem
  griechischen Salat-Setup vom Oktopus).
- **Portionen:** 4 Auberginen für 2 Erwachsene + Kind sind bewusst reichlich
  (je 1 pro Erwachsenem am Abend, Rest kalt am Folgetag) — Reste sind hier
  Feature, nicht Bug.
- **Reste:** Kalt aus dem Kühlschrank am nächsten Tag fast am besten; Sudreste
  über Pasta oder als Basis für ein schnelles Tomaten-Schmorgemüse.
- **Quellen (geprüft):**
  - [Ozlem's Turkish Table — Imam Bayildi](https://ozlemsturkishtable.com/2013/07/a-turkish-classic-eggplants-stuffed-with-onion-garlic-and-tomatoes-in-olive-oil-imam-bayildi/)
    (türkische Kochbuchautorin): Zebra-Schälen, Salzen 10–15 Min., Garen in
