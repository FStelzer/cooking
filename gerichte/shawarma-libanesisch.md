...
**Zur Herkunft:** Die Technik ist osmanisch-türkisch (*çevirme* = drehen → auch Ursprung von „Döner"), Shawarma selbst ist panlevantinisch. Die hier beschriebene Ausprägung — Hähnchen, Toum, Gurke, dünnes Markook — ist aber tatsächlich spezifisch libanesisch.

**Erster Durchgang = Variante A (Pfanne).** Variante B (Kastenform) ist unten vollständig dokumentiert und liefert die echte geschabte Textur — kostet aber einen Tag Vorlauf. Erst A kochen, dann entscheiden, ob B den Aufwand wert ist.

> **Kombinierbarkeit:** Bewusst ein **eigener Abend**, getrennt vom Mezze-Projekt (`mezze-libanesisch.md`). Tabbouleh, Batata harra und Toum gehören **hierher**, nicht zum Mezze — die Abgrenzung ist dort dokumentiert. Wer irgendwann ein großes libanesisches Menü will: Mezze als Vorspiel, Shawarma als Hauptgang, dann aber Tabbouleh **oder** Batata harra streichen, sonst kippt die Menge.

## Beschaffung

- **Türkischer/arabischer Laden — noch zu identifizieren (Raum Dietzenbach/Offenbach).** Bleibt der Engpass des Projekts. Dort zu holen: Markook/Saj, 7-Gewürz/Baharat, feiner Bulgur (Nr. 1), salzige Gurken, rosa Rüben, gute Tahina, evtl. fertige Shatta. **Alles davon hat einen Fallback** (siehe Einkaufsliste) — das Projekt scheitert nicht am Laden, wird ohne ihn nur eine Stufe weniger gut.
- **Gute Tahina ist der größte Qualitätshebel des ganzen libanesischen Blocks.** Supermarkt-Tahina ist häufig bitter. Libanesische oder palästinensische Marke, großes Glas — wird beim Mezze-Projekt ohnehin gebraucht. Hier ist die Menge klein (Sauce ist nur ein Hauch), aber bittere Tahina schmeckt man trotzdem.
- **REWE Center:** Hähnchenschenkel zuverlässig — **mit Knochen kaufen und selbst entbeinen** ist günstiger, und die Knochen wandern in den TK-Vorrat für die nächste Brühe. Rest: Joghurt, Zitronen (viel — siehe Mengen-Check), Knoblauch, mehligkochende Kartoffeln, Kräuter, neutrales Öl.
- **Brot-Realität:** Frisches Markook gibt es im REWE Center nicht. Fallback-Kette: Yufka/Lavash aus dem Türkei-Regal (funktioniert, etwas dicker) → notfalls Pita, dann aber offen flach gepresst servieren statt gewickelt. Egal welches Brot: **taufrisch** kaufen, altes Fladenbrot bricht beim Wickeln.
...
- **Ehrlicher Streichkandidat beim ersten Durchgang: die Batata harra.** Tabbouleh + Batata harra ist reichlich Beilage für 4 Wraps. Tabbouleh bleibt gesetzt, weil es komplett kalt vorbereitbar ist und die frische Säure zum fetten Wrap liefert. Die Batata harra ist die dritte heiße Baustelle in der kritischen letzten halben Stunde (Fleisch, Wraps pressen, Kartoffeln in zwei Pfannen) — wer den Ablauf entspannen will, streicht sie und macht sie beim zweiten Durchgang, wenn das Wrap-Pressen schon sitzt.
- Toum-Reste sind ein Feature, kein Problem: hält 3–4 Wochen und ist grandios zu gebratenem Gemüse, auf Brot, zu Kartoffeln.
- Orientalischen Laden nach dem Einkauf bewerten → Einkaufsquellen in CLAUDE.md ergänzen (steht auch in der Einkaufsliste).
...
- **Kein Tahin? Doch, aber wenig.** Puristische libanesische Quellen bestehen darauf, dass ins Hähnchen-Shawarma nur Toum, Pickles und Pommes gehören und Tahin die anderen Aromen zudeckt ([Zaatar and Zaytoun](https://zaatarandzaytoun.com/chicken-shawarma/), [Hadia's Lebanese Cuisine](https://hadiaslebanesecuisine.com/blog/smoky-chicken-shawarma/)); Tarator/Tahin ist traditionell die Sauce zu Rind/Lamm. Andere libanesische Quellen führen Toum *und* Tahin bzw. Joghurt-Minze ([A Pinch of Adventure](https://apinchofadventure.com/lebanese-chicken-shawarma-the-best-authentic-shawarma-recipe/), [Tiffin and Tea](https://tiffinandteaofficial.com/authentic-lebanese-chicken-shawarma/)). → Wir folgen der Erinnerung an den Laden: Toum als Basis, Tahin nur als Hauch.
- **Keine Pommes im Wrap:** klassisch wären sie drin, werden hier aber bewusst weggelassen — sonst zweimal Kartoffel neben der Batata harra, und der Wrap soll dünn bleiben.
- **Tabbouleh statt „Kräutersalat mit Koriander":** ein Petersilie-Minze-Koriander-Salat ist kein kanonisches libanesisches Gericht. Tabbouleh ist ein Petersiliensalat, Koriander gehört traditionell nicht hinein ([Feel Good Foodie](https://feelgoodfoodie.net/recipe/traditional-lebanese-tabbouleh-salad/), [Maureen Abood](https://maureenabood.com/lebanese-tabbouleh-salad-recipe/)). Der erinnerte Koriander stammt mit hoher Wahrscheinlichkeit aus der Batata harra.
