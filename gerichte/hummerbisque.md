# Hummerbisque (4 Portionen als Vorspeise)

*Aktive Zeit ~1 Std., gesamt ~2 Std. Equipment: großer Topf, Küchenschere, schweres Messer/Beil, Stabmixer, feines Sieb (Chinois), Kartoffelstampfer.*

## Beschaffung

- **Hummer:** Zuerst bei **Buhara Seafood (Dietzenbach)** anfragen — frisch oder roh ist erste Wahl. Falls nicht verfügbar: **roher TK-Hummer bei Selgros** (dort dann auch gleich die Garnelen mitnehmen). Rechtzeitig vor dem Kochtag klären!
- **Garnelen mit Schale:** Buhara, Selgros (TK) oder Asialaden.
...
**1. Hummer blanchieren (3–4 Min.)**
Großen Topf mit stark gesalzenem Wasser (wie Meerwasser) sprudelnd aufkochen. Hummer kopfüber zügig hineingeben, Deckel drauf, genau 3–4 Min. blanchieren, sofort in Eiswasser abschrecken. *Tipp: Das Fleisch bleibt bewusst fast roh – es löst sich so aus der Schale und gart erst am Ende schonend fertig. TK-Ware über Nacht im Kühlschrank auftauen — auch aufgetauter roher TK-Hummer wird genauso kurz blanchiert, der Auslöse-Trick funktioniert identisch.*

**2. Zerlegen: Schwanz & Scheren abdrehen**
Schwanz mit einer Drehbewegung vom Kopf abdrehen. Beide Scheren samt Gelenken abdrehen. *Über einer Schüssel arbeiten – auslaufende Flüssigkeit später mit in den Topf.*

**3. Fleisch auslösen, Garnelen schälen**
Schwanz: dünne Unterseite des Panzers mit der Schere links und rechts längs aufschneiden, Bauchplatte abziehen, Fleisch am Stück herauslösen. Rücken des Fleischs längs flach einschneiden, dunklen Darmfaden herausziehen. Scheren: mit Messerrücken/Nussknacker anknacken, Fleisch auslösen – auch im Gelenk sitzt Fleisch. Garnelen schälen und entdarmen: Schalen und Köpfe zu den Hummerkarkassen, Fleisch zum Hummerfleisch. Alles Fleisch abgedeckt kühl stellen.

**4. Karkassen vorbereiten**
...
**12. Aufmontieren & Servieren**
Falls Corail vorhanden: mit den 30 g eiskalter Butter verkneten. Suppe heiß, aber nicht mehr kochend: die (Corail-)Butter zugeben, mit dem Stabmixer schräg gehalten kräftig aufmixen bis leicht schaumig. Fleisch in vorgewärmte Teller, Bisque angießen, Erwachsenen-Teller mit einer Prise Cayenne würzen, sofort servieren.

## Kinder-Anpassung

- Cayenne nur pro Teller (Erwachsene), Kinderportion bleibt mild.
- Alkohol ist nach Flambieren + 40 Min. offenem Köcheln + Reduktion praktisch vollständig verkocht — unbedenklich.
- Ein paar extra Stücke Hummer/Garnele für den Kinderteller einplanen.

## Notizen

- **Vorbereiten:** Bis Schritt 10 am Vortag machbar – durchgezogen schmeckt sie sogar besser. Fleisch erst kurz vor dem Servieren garen.
- **Intensität:** Die Garnelenkarkassen sind fester Bestandteil, kein Fallback — ein 600-g-Hummer allein auf 1 L Flüssigkeit ergibt eine zu milde Bisque. Restaurants nutzen deutlich mehr Karkassen pro Liter.
