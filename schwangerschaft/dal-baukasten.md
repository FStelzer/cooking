...
1. **Linsen kochen** mit Kurkuma und etwas Fett (Schaum bricht), Salz **erst am Ende** — beide Referenzen salzen nach dem Garen.
2. **Masala** separat in der Pfanne: Zwiebel wirklich goldbraun (8–10 Min., Basis-Süße), Ingwer-Knoblauch, Tomate einkochen, bis sich Fett am Rand absetzt. Unterrühren.
...
| | A — Dal Palak | B — Chana Dal mit Kürbis | C — Kokos-Dal (Kerala) | D — Dal makhani |
|---|---|---|---|---|
...
Dal ist das ideale GDM-Vorratsessen (Leitfaden-Regel 5: Zwischenmahlzeiten sind Pflicht):

- **Ohne Tadka einfrieren**, Tadka frisch beim Aufwärmen — das Aroma der aufgeblühten Gewürze überlebt den Frost nicht gut, der Rest schon. Grundrezept ×1,5 kochen kostet keine Minute mehr.
- **Portionen:** 150 g als Zwischen-/Spätmahlzeit (\~20 g KH + 8 g Protein), 300 g als Hauptportion. Babybrei-Gefrierform mit großen Mulden fürs Snack-Format (Muldenvolumen laut CLAUDE.md noch ausmessen), Dosen fürs Hauptgericht. Hält 3 Monate.
- **Kühlschrank:** 3–4 Tage; dickt stark nach → mit heißem Wasser aufrühren, aufkochen. Variante A (Spinat) innerhalb von 2 Tagen.
- **Aufwärmen für Schwangere:** einmal sprudelnd aufkochen, nicht nur lauwarm.

## Schwangerschaft & GDM

**Warum Linsen der Anker sind — belegt, nicht Bauchgefühl:**

- **Glykämischer Index:** In den internationalen GI-Tabellen (Atkinson et al. 2008) liegen Linsen bei **32 ± 5**, Kichererbsen bei 28, Kidneybohnen bei 24 — Basmati \~55–60, Weißbrot 75, Kartoffel 80+. Die 2021er Tabellen differenzieren: rote Linsen gekocht **18–32**, **Chana Dal 11–13**, Mungbohnen \~42. Hülsenfrüchte sind damit die KH-Quelle mit der flachsten Kurve, die es gibt.
- **Direkter Vergleich:** Moravek et al. (J Nutr 2018, University of Guelph) ersetzten in einer Mahlzeit die halbe Reis- bzw. Kartoffelportion durch Linsen: postprandiale Glukoseantwort **\~20 % niedriger als Reis, \~35 % niedriger als Kartoffel** (gesunde Erwachsene, akute Mahlzeit — nicht GDM-spezifisch, aber der Mechanismus ist derselbe).
- **Meta-Analyse:** Sievenpiper et al. (Diabetologia 2009): Hülsenfrüchte allein senkten Nüchternglukose und Insulin signifikant; hohe Heterogenität, aber konsistente Richtung.
- **Leitlinie:** DDG-Praxisempfehlung GDM 2024: KH 40–50 % der Energie, **„Kohlenhydrate mit hohem Ballaststoffanteil und niedrigem glykämischem Index sollen bevorzugt werden"**, 3 Haupt- + 2–3 Zwischenmahlzeiten. Diabetes UK nennt „pulses like chickpeas, beans and lentils" ausdrücklich als bessere KH-Wahl bei GDM. Beide betonen: **entscheidend bleibt die Menge, und die Reaktion ist individuell → messen.**

**KH-Rechnung pro Hauptportion** (Näherungen — 300 g trockene Linsen auf 4 Portionen):

| Komponente | KH | Protein |
|---|---|---|
| 300 g Dal (aus 75 g trockenem Masoor) | \~40 g | \~19 g |
| 1 Vollkorn-Roti (\~33 g Mehl) | \~20 g | \~4 g |
| Kachumber | \~5 g | — |
| Raita (statt Kachumber) | \~4 g | \~3 g |
| 1 hartes Ei | 0 g | \~7 g |
| **Gesamt mit Roti** | **\~65 g** | **\~25–30 g** |
| **ohne Roti** | **\~45 g** | |

Das ist eine **volle Hauptmahlzeit am oberen Ende** — bewusst, weil das Dal hier das Gericht ist. **Reihenfolge beim Anpassen, falls das Messgerät hoch geht:** zuerst Roti weglassen (−20 g), dann Dal-Portion auf 220 g (−12 g) und dafür Ei/Raita/mehr Kachumber. Nicht die Linsen gegen Reis tauschen — das wäre die falsche Richtung. **Chana Dal (B)** ist die günstigste Variante, **Kokos-Moong (C)** hat den höchsten Linsen-GI, wird aber durch Kokosfett gebremst; **Makhani (D)** hat guten GI, ist aber kalorisch die schwerste → kleinere Portion, dafür mehr Kachumber.

**Sicherheit:** Alles durchgekocht; Joghurt pasteurisiert; Kidneybohnen (D) vollständig gar; Hing in Kochmengen unbedenklich (bei Unsicherheit weglassen); kein Alkohol; Eier hart (Eigelb fest).

**Timing:** Dal ist ein langsames Essen — Spaziergang danach passt.

## Kinder-Anpassung

- **Teilen vor dem Chili** (Schritt 4) ist die ganze Kinder-Logik — die Kinderportion ist vollwertig gewürzt (Kreuzkümmel, Knoblauch, Garam Masala), nur nicht scharf. Bei Variante D erst nach dem Simmern teilen (bis dahin kein Chili drin).
- **Einstiegs-Variante:** C (Kokos, mild, süßlich) oder das Grundrezept; A (Spinat, herb) und D (schwer) danach.
- **Roti zum Tunken und hartes Ei** sind die sicheren Treffer; Kachumber ohne rote Zwiebel abzweigen.
- **Mitmachen:** Roti ausrollen, Linsen waschen, Tadka-Zischen zuschauen (Abstand — Senfsamen springen).
- Koriandergrün nach Vorliebe weglassen.
